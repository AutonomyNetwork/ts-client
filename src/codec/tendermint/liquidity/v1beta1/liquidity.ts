...
export const Params = {
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    const message = { ...baseParams } as Params;
    message.poolTypes = (object.poolTypes ?? []).map((e) =>
      PoolType.fromPartial(e)
    );
    ...
    message.poolCreationFee = (object.poolCreationFee ?? []).map((e) =>
      Coin.fromPartial(e)
    );
  ...
  fromPartial(object: DeepPartial<PoolMetadata>): PoolMetadata {
    ...
    message.poolCoinTotalSupply =
      ...
      object.poolCoinTotalSupply !== null
        ...
        : undefined;
    message.reserveCoins = (object.reserveCoins ?? []).map((e) =>
      Coin.fromPartial(e)
    );
    return message;
  },
