  ...
  fromJSON(object: any): PoolRecord {
    ...
    message.poolBatch =
      object.poolBatch !== undefined && object.poolBatch !== null
        ...
        : undefined;
    message.depositMsgStates = (object.depositMsgStates ?? []).map((e: any) =>
      DepositMsgState.fromJSON(e)
    );
    message.withdrawMsgStates = (object.withdrawMsgStates ?? []).map((e: any) =>
      WithdrawMsgState.fromJSON(e)
    );
    message.swapMsgStates = (object.swapMsgStates ?? []).map((e: any) =>
      SwapMsgState.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial(object: DeepPartial<PoolRecord>): PoolRecord {
    ...
    message.poolBatch =
      object.poolBatch !== undefined && object.poolBatch !== null
        ...
        : undefined;
    message.depositMsgStates = (object.depositMsgStates ?? []).map((e) =>
      DepositMsgState.fromPartial(e)
    );
    message.withdrawMsgStates = (object.withdrawMsgStates ?? []).map((e) =>
      WithdrawMsgState.fromPartial(e)
    );
    message.swapMsgStates = (object.swapMsgStates ?? []).map((e) =>
      SwapMsgState.fromPartial(e)
    );
    return message;
  },
};
  ...
  fromJSON(object: any): GenesisState {
    ...
    message.params =
      object.params !== undefined && object.params !== null
        ...
        : undefined;
    message.poolRecords = (object.poolRecords ?? []).map((e: any) =>
      PoolRecord.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    message.params =
      object.params !== undefined && object.params !== null
        ...
        : undefined;
    message.poolRecords = (object.poolRecords ?? []).map((e) =>
      PoolRecord.fromPartial(e)
    );
    return message;
  },
};
