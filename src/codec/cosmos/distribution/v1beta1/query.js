...
class QueryClientImpl {
  ...
  ValidatorOutstandingRewards(request) {
    ...
    return promise.then((data) =>
      exports.QueryValidatorOutstandingRewardsResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  ...
  DelegationTotalRewards(request) {
    ...
    return promise.then((data) =>
      exports.QueryDelegationTotalRewardsResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  ...
  DelegatorWithdrawAddress(request) {
    ...
    return promise.then((data) =>
      exports.QueryDelegatorWithdrawAddressResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
