...
class MsgClientImpl {
  ...
  WithdrawDelegatorReward(request) {
    ...
    return promise.then((data) =>
      exports.MsgWithdrawDelegatorRewardResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  WithdrawValidatorCommission(request) {
    ...
    return promise.then((data) =>
      exports.MsgWithdrawValidatorCommissionResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
